...
- [충돌 기록](docs/conflict-resolution.md): 우발 충돌 3건은 의도적 실습에서 제외합니다. 이준혁·최건영의 `practice_1` 같은 줄 충돌 2건은 Git 이력으로 확인됐습니다. `practice_2` 시도에는 최건영의 해당 줄 변경 커밋도 확인되었습니다.
